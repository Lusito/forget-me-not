...
for (const key of Object.keys(defaultSettings)) {
    ...
    if (type === "boolean") testOverrides[key] = !defaultSettings[key];
    else if (type === "number") testOverrides[key] = (defaultSettings[key] as number) + 1;
...
describe("Settings", () => {
    ...
    describe("save", () => {
        ...
        beforeEach(() => {
            if (!settings2) settings2 = new Settings();
        });
        afterEach(() => {
            settings2 = null;
        });
